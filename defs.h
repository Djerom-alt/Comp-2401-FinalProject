...
#define MAX_ROOMS 24
#define MAX_ROOM_OCCUPANCY 1000 // original 8
...
struct Room {
    ...
    struct Room* adjacent_rooms[MAX_CONNECTIONS];
    struct Ghost* ghost;
    ...
    bool is_exit;
    sem_t mutex; // multi-threading optional, look a room when cleaning
};
...
struct House {
    ...
    struct CaseFile case_file;
    struct Ghost ghost;
    struct HunterCollection hunter_collection;
    int room_count;
};
